...
const SortModal = ({ uid, mainField, contentType, mode = "global", label }) => {
  ...
  const [appliedFilterSearchTerm, setAppliedFilterSearchTerm] = useState("");
              ...
              return /* @__PURE__ */ jsxs(Box, { children: [
                ...
                /* @__PURE__ */ jsx(Box, { paddingTop: 2, children: needsTextInput ? (
                  ...
                  /* @__PURE__ */ jsxs(Fragment$1, { children: [
                    selectedAttr?.type === "relation" && /* @__PURE__ */ jsx(Box, { paddingBottom: 2, children: /* @__PURE__ */ jsxs(Flex, { gap: 2, alignItems: "flex-end", children: [

...
const SortModal = ({ uid, mainField, contentType, mode = "global", label }) => {
  ...
  return /* @__PURE__ */ jsx(Tooltip.Provider, { delayDuration: 300, skipDelayDuration: 0, children: /* @__PURE__ */ jsxs(Modal.Root, { open: isOpen, onOpenChange: setIsOpen, children: [

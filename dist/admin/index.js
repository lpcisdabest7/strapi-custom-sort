...
const SortModal = ({ uid, mainField, contentType, mode = "global", label }) => {
  ...
  const [filterSearchInputValue, setFilterSearchInputValue] = React.useState("");
  const [appliedFilterSearchTerm, setAppliedFilterSearchTerm] = React.useState("");
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Content, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Body, { children: [
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { paddingBottom: 4, children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "omega", fontWeight: "semiBold", as: "label", textColor: "neutral800", children: mode === "scoped" ? "View by" : "Sort by field" }),
              ...
              return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingTop: 2, children: needsTextInput ? (
                  ...
                  /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
                    selectedAttr?.type === "relation" && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingBottom: 2, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 2, alignItems: "flex-end", children: [
                      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { grow: 1, children: /* @__PURE__ */ jsxRuntime.jsx(
                        designSystem.TextInput,
                        {
                          type: "text",
                      ...
                      /* @__PURE__ */ jsxRuntime.jsx(
                        designSystem.Button,
                        {
                          variant: "secondary",
                          disabled: isSubmitting || isLoadingOptions,
                          onClick: () => setAppliedFilterSearchTerm(filterSearchInputValue.trim()),
                          children: "Search"
                        }
                      )
                    ] }) }),
                    /* @__PURE__ */ jsxRuntime.jsx(
                      designSystem.SingleSelect,
                      {
                        ...
                        disabled: isSubmitting || isLoadingOptions,
                        placeholder: isLoadingOptions ? "Loading options..." : selectedAttr?.type === "relation" ? appliedFilterSearchTerm ? filterOptions.length === 0 ? "No results found, try different search" : "Select from search results" : "Type to search or select from list" : "Select a value",
                        clearLabel: "Clear selection",
